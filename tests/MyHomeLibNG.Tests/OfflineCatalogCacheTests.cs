...
public sealed class OfflineCatalogCacheTests
{
    ...
    public async Task ReusesCatalogAcrossProviderInstances()
    {
        ...
        var firstProvider = new OfflineBookProvider(profile, cache, locationResolver, storageRegistry);
        var secondProvider = new OfflineBookProvider(profile, cache, locationResolver, storageRegistry);
